const scheemaDoc = {
  ...
  properties: {
    ...
    location: {
      type: 'object',
      description: 'The location object of the local (state, city, street).',
      properties: {
        state: {
          type: 'string',
            ...
            schema: {
              ...
              properties: {
                ...
                location: {
                  ...
                  example: 'California,Los Angeles,Main Street',
                },
                stars: {
                  type: 'string',
                  description:
                ...
                open: {
                  type: 'string',
                  description: 'The opening time of the local.',
                  example: '9:00 AM',
                },
                close: {
                  type: 'string',
                  description: 'The closing time of the local.',
                  example: '5:00 PM',
                },
              },
            },
              ...
              schema: {
                ...
                properties: {
                  message: {
                    ...
                    example: 'Local Coffee Shop already exists',
                  },
                },
              },
            },
            ...
            schema: {
              ...
              properties: {
                ...
                location: {
                  ...
                  example: 'United States,New York,Main Street',
                },
                stars: {
                  type: 'string',
                  description:
          ...
          'application/json': {
            schema: {
              ...
              properties: {
                name: {
                  type: 'string',
                  description: 'The name of the local to be deleted.',
                  example: 'Local Coffee Shop',
                },
              },
            },
            ...
            'application/json': {
              schema: {
                ...
                properties: {
                  ...
                  data: {
                    type: 'array',
                    description: 'Array of local objects sorted by ranking.',
                    items: {
                      $ref: '#/components/schemas/Local',
                    },
                  },
